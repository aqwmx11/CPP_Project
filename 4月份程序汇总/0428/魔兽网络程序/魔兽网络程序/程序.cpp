...
/*
08.string Warrior::names[WARRIOR_NUM] = { "dragon","ninja","iceman","lion","wolf" };
09.红方司令部按照 iceman、lion、wolf、ninja、dragon 的顺序制造武士。
10.蓝方司令部按照 lion、dragon、ninja、iceman、wolf 的顺序制造武士。
11.*/
class Headquarter;
class Warrior
{
